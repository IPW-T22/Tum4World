...
<body>
    ...
    <main>
        ...
        <div>
            <img id="im1" src="${pageContext.request.contextPath}/images/immagine4.jpg" alt="Immagine rappresentativa dell'associazione">
        </div>
        ...
        <div>
            <a href="${pageContext.request.contextPath}/images/TUM4WORD%20volantino.pdf" download><button>Clicca qui</button></a>
        </div>
    </main>
